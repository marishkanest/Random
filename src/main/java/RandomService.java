        ...
        while (true) { //запускаем цикл
            ...
            try { //для исключения блок
                ...
                if (studentElement2.team != studentElement.team                        //если команды студентов разные
                    ...
                    System.out.println("Спрашивает: " + studentElement.getName() + " из команды №" + studentElement.getTeam()); //спрашивает первый
                    System.out.println("Отвечает: " + studentElement2.getName() + " из команды №" + studentElement2.getTeam()); //отвечает второй
                ...
                if (source.size() == 2 && studentElement.team == studentElement2.team && studentElement != studentElement2
                    ...
                    System.out.println("Спрашивает: " + studentElement.getName() + " из команды №" + studentElement.getTeam()); //спрашивает первый
                    System.out.println("Отвечает: люди из одной команды " + studentElement2.getName() + " из команды №" + studentElement2.getTeam()); //отвечает второй
                ...
                if (source.size() == 1
                    ...
                    System.out.println("остался один человек: " + studentElement.getName() + " из команды №" + studentElement.getTeam());
                    source.remove(studentElement);
                }
